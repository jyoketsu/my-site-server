...
var categoryDao_1 = __importDefault(require("../dao/categoryDao"));
var articleDao_1 = __importDefault(require("../dao/articleDao"));
var checkAuth_1 = require("../util/checkAuth");
var router = express_1.default.Router();
// 获取分类
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var categoryDao, articleDao, result, countRes, _loop_1, index;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                categoryDao = new categoryDao_1.default();
                articleDao = new articleDao_1.default();
                return [4 /*yield*/, categoryDao.findAll(undefined, undefined, {
                        sort: { updateTime: -1 },
                    })];
            case 1:
                result = _a.sent();
...
router.post("/create", [
    ...
    var editable, errors, categoryDao, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, categoryDao.create({
                        name: req.body.name,
                        count: 0,
                    })];
            case 2:
...
router.patch("/update", [
    ...
    var editable, errors, categoryDao, result, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                editable = (0, checkAuth_1.checkEditable)(req, res);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                categoryDao = new categoryDao_1.default();
                return [4 /*yield*/, categoryDao.update({ _id: req.body._id }, req.body.updater)];
            case 2:
                result = _a.sent();
                res.json({ status: 200, result: result });
                return [3 /*break*/, 4];
            case 3:
                ...
                res.json({
                    status: 500,
                    error: error_2,
                    msg: error_2 && error_2.code === 11000 ? "该分类已存在！" : "服务出错！",
                });
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
router.delete("/delete", [(0, express_validator_1.check)("_id").notEmpty().withMessage("缺少_id！")], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var editable, errors, categoryDao, result, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                editable = (0, checkAuth_1.checkEditable)(req, res);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                categoryDao = new categoryDao_1.default();
                return [4 /*yield*/, categoryDao.deleteOne({ _id: req.body._id })];
            case 2:
                result = _a.sent();
                res.json({ status: 200, result: result });
                return [3 /*break*/, 4];
...
router.get("/count", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var categoryDao, result, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                categoryDao = new categoryDao_1.default();
                return [4 /*yield*/, categoryDao.count({})];
            case 1:
                result = _a.sent();
                res.json({ status: 200, result: result });
                return [3 /*break*/, 3];
